...
public class ParseFD {
    ...
    public static void parse(String filePath,String folder)throws IOException {
        Path path = Paths.get(filePath);
        String fileName=  path.getFileName().toString().replace("FD","P");

        String FlowDroidResultFile = "";
        String sink = "";
        if(filePath.contains(".txt"))
            FlowDroidResultFile =folder+fileName;

        BufferedWriter writer = new BufferedWriter(new FileWriter(FlowDroidResultFile));
        BufferedReader flowDroidResultsReader = new BufferedReader(new FileReader(filePath));
